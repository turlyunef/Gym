...
public class Day implements Serializable {
    ...
    public Day(Day day, Exs exs) {
        this.dd = day.dd;
        this.mm = day.mm;
        this.yy = day.yy;
        this.chekDay = 1;

        this.exs = new Exs[(day.exs.length) + 1]; //Создаем новый массив упражнений конкретного дня с количеством элементов на 1 больше, чем у внесенного через параметры
